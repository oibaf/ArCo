...
public class SpecificCulturalPropertyType {
	...
	static{
		...
		/*  Property types for SCAN (OG/SET) */
		...
		/*  Property types for MODI (OG/AMB) */
		...
		sheetPropertyTypeMap.put("MINP", NAMESPACE + "ArchaeologicalProperty");
		...
		sheetPropertyTypeMap.put("SU",   NAMESPACE + "ArchitecturalOrLandscapeHeritage");
		...
		sheetPropertyTypeMap.put("EVE",  NAMESPACE + "Event");
	}
