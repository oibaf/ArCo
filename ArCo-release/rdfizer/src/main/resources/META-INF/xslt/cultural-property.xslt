     ...
     -->
		...
		<!--	<xsl:if test="record/metadata/schede/*/OG/OGT/OGTP and ($sheetVersion='4.00_ICCD0' or $sheetVersion='4.00')">
			...
			<rdf:Description>
				...
				<xsl:choose>
					<xsl:when test="record/metadata/schede/harvesting/idContenitoreGiuridico and count(arco-fn:find-cg(record/metadata/schede/harvesting/idContenitoreGiuridico)) > 0">
      ...
      <!-- AUIY maxOccurs="unbounded"
       ...
       --><!-- see part.xslt missing rdf:Description -->
							<xsl:when test="./* and (not(./AUIY) or ./AUIY[.='intero bene' or .='integrale' or .='tutta' or .='totale' or starts-with(lower-case(normalize-space()), 'nr') or starts-with(lower-case(normalize-space()), 'n.r') or starts-with(lower-case(normalize-space()), 'intero') or starts-with(lower-case(normalize-space()), 'intera') or starts-with(lower-case(normalize-space()), 'esemplar')])">
								<arco-cd:hasAuthorshipAttribution>
									<xsl:attribute name="rdf:resource">
										<xsl:value-of select="concat($NS, 'PreferredAuthorshipAttribution/', $itemURI, '-', position())" />
									</xsl:attribute>
				...
				<xsl:for-each select="record/metadata/schede/*/MT/RST">
					<arco-cd:hasIntervention>
						<xsl:attribute name="rdf:resource">
							<xsl:value-of select="concat($NS, 'Intervention/', $itemURI, 'intervention-', position())" />
						</xsl:attribute>
				...
				<xsl:for-each select="record/metadata/schede/*/OG/OGD[OGDN]">
					<arco-dd:hasDesignationInTime>
						<xsl:attribute name="rdf:resource">
